...
//        String branch = safeRequest(request, "branch");
        ...
        String base64 = create(pathtemp, output);
...
//            quartatabella.add(b1.getCod() + "\n" + b1.getDe_branch() + "\n" + formatMysqltoDisplay(b1.getMax_ass()));
        ...
        String base64 = create(pathtemp, primatabella, secondatabella, terzatabella, quartatabella,
    ...
    protected void budget(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String base64 = create(pathtemp, primatabella, secondatabella, terzatabella,
...
//                    }
        ...
        String base64 = giornalieroCG(pathtemp, dtstart.dayOfMonth().getMaximumValue(), ultimogiornocontrollato.dayOfMonth().get(),
