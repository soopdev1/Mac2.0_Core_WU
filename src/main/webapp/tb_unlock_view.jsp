                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" disabled="disabled" value="<%=code%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Used By</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" disabled="disabled" value="<%=cs.getUser_gen()%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Branch ID</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" disabled="disabled" value="<%=branch%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Type Usage</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" disabled="disabled" value="<%=type%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Transaction ID</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" disabled="disabled" value="<%=trid%>"/> 
                                            </div>
                                        </div>
                                        <div class="form-group">
