            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_booking">
                        ...
                        <input type="hidden" name="status_or" value="<%=bo.getStato()%>"/>
                        <input type="hidden" name="branch_or" value="<%=bo.getFiliale()%>"/>
                        <input type="hidden" name="branch" value="<%=bo.getFiliale()%>"/>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control date-picker" 
                                                           name="dt_ritiro" id="dt_ritiro" value="<%=Utility.formatStringtoStringDate(bo.getDt_ritiro(), Constant.patternsql, Constant.patternnormdate_filter)%>"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
