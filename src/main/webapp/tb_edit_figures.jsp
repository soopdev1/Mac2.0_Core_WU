                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Figures - Branch: <%=fil%></span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           id="fi_code" name="fi_code" onkeypress="return keysub(this, event);" value="<%=fi_code%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" onkeypress="return keysub(this, event);"
                                                           value="<%=fi.getDe_supporto()%>" readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" id="ex1">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="buy_com" name="buy_com" 
                                                           ...
                                                           value="<%=fi.getCommissione_acquisto()%>" readonly="readonly"> 
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="buy_thr" name="buy_thr" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                           value="<%=fi.getBuy_comm_soglia_causale()%>" readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group" id="ex2">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="buy_fix" name="buy_fix" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                           value="<%=fi.getFix_buy_commission()%>"readonly="readonly"> 
                                                </div>
                                                <div class="form-group" id="ex2A">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="buy_bac" name="buy_bac" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getBuy_back_commission()%>" readonly="readonly"> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="ex3">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="sel_com" name="sel_com" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                           value="<%=fi.getCommissione_vendita()%>"readonly="readonly"> 
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="sel_thr" name="sel_thr" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                           value="<%=fi.getSell_comm_soglia_causale()%>"readonly="readonly"> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" id="ex4">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="sel_fix" name="sel_fix" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');" 
                                                           value="<%=fi.getFix_sell_commission()%>"readonly="readonly"> 
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="sel_bac" name="sel_bac" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                           value="<%=fi.getSell_back_commission()%>"readonly="readonly"> 
                                                </div>
                                                ...
                                                <div id="uplt">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="upl_thr" name="upl_thr" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getUpload_thr()%>" readonly="readonly">
                                                ...
                                                <div class="form-group" id="ex1">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="buy_com" name="buy_com" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');" 
                                                               value="<%=fi.getCommissione_acquisto()%>"> 
                                                    </div>
                                                    <label class="col-md-3 control-label">Threshold Buy</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="buy_thr" name="buy_thr" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getBuy_comm_soglia_causale()%>"> 
                                                    </div>
                                                </div>
                                                <div class="form-group" id="ex2">
                                                    <label class="col-md-3 control-label">Buy Fix Commission</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="buy_fix" name="buy_fix" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getFix_buy_commission()%>"> 
                                                    </div>
                                                    <div class="form-group" id="ex2A">
                                                        <label class="col-md-3 control-label">Buy Back Commission</label>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control" id="buy_bac" name="buy_bac" 
                                                                   onkeypress="return keysub(this, event);"
                                                                   onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                                   value="<%=fi.getBuy_back_commission()%>"> 
                                                        </div>
                                                    </div>
                                                </div>
                                                <div><hr></div>
                                                <div class="form-group" id="ex3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="sel_com" name="sel_com" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getCommissione_vendita()%>"> 
                                                    </div>
                                                    <label class="col-md-3 control-label">Threshold Sell</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="sel_thr" name="sel_thr" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getSell_comm_soglia_causale()%>"> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" id="ex4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="sel_fix" name="sel_fix" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');" 
                                                               value="<%=fi.getFix_sell_commission()%>"> 
                                                    </div>
                                                    <label class="col-md-3 control-label">Sell Back Commission</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="sel_bac" name="sel_bac" 
                                                               onkeypress="return keysub(this, event);"
                                                               onchange="return formatValueDecimal_1(this, '', '<%=decimal%>');"
                                                               value="<%=fi.getSell_back_commission()%>"> 
                                                    </div>
