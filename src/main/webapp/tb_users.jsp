...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma25.jsp"%>
            <!-- END MENU -->
            <%                String lan_index = (String) session.getAttribute("language");
                ...
                String vis = "";
                if (head.getShowagency().equals("1")) {
                    vis = "checked";
                }
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Users</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <a href="tb_edit_users.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New User</a>
                                    <a href="tb_users_kyc.jsp" class="btn btn-outline dark" target="_blank"><i class="fa fa-user-plus"></i> User KYC modify </a>
                            </div>
                        </div>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Users</span>
                                    </div>
                                    <div class="actions">
                                                                ...
                                                                buttons: [
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {
                                                                            ...
                                                                            window.open('Fileview?type=tb_users&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {
                                                                            ...
                                                                            window.open('Fileview?type=tb_users&value=pdf', '_blank');
                                                                        }
                                                                    },
