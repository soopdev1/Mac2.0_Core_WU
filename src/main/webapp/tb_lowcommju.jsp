...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Low Commission Justify</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma20.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Low Commission Justify</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_lowcommju.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Low Commission Justify</a>
                                <%if (Constant.is_IT) {%>
                                |
                                <a href="threshold_edit.jsp" class="btn btn-outline blue fancyBoxRafreload "><i class="fa fa-edit"></i> Level Rate Threshold</a>
                                <%}%>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Low Commission Justify</span>
                                    </div>
                                    <div class="actions">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    for (int i = 0; i < array_undermincommjustify.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=array_undermincommjustify.get(i)[0]%></td>
                                                                    <td><%=array_undermincommjustify.get(i)[1]%></td>
                                                                    <td><%=Engine.formatStatus_general(array_undermincommjustify.get(i)[2])%></td>
                                                                    <td><%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_lowcommju.jsp?lo_code=<%=array_undermincommjustify.get(i)[0]%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_lowcomm&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_lowcomm&value=pdf', '_blank');
                                                    }
                                                },
