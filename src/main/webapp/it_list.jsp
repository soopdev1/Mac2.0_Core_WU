                        ...
                        jQuery(document).ready(function () {
                            var dt2 = function () {
                                ...
                                g.dataTable({
                                    ...
                                    ajax: {
                                        url: "Query?type=it_list&typeop=<%=request.getParameter("typeop")%>&branch=<%=request.getParameter("branch")%>&d1=<%=request.getParameter("d1")%>&d2=<%=request.getParameter("d2")%>",
                                                            dataSrc: "aaData",
                                                            type: "GET"
                                                        },
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=it_list&typeop=<%=request.getParameter("typeop")%>&branch=<%=request.getParameter("branch")%>&d1=<%=request.getParameter("d1")%>&d2=<%=request.getParameter("d2")%>&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=it_list&typeop=<%=request.getParameter("typeop")%>&branch=<%=request.getParameter("branch")%>&d1=<%=request.getParameter("d1")%>&d2=<%=request.getParameter("d2")%>&value=pdf', '_blank');
                                                    }
                                                },
