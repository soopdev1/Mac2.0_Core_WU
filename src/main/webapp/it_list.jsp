                                    ...
                                    buttons: [
                                        {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                            ...
                                            action: function (e, dt, node, config) {
                                                window.open('Fileview?type=it_list&typeop=<%=typeop%>&branch=<%=branch%>&d1=<%=d1%>&d2=<%=d2%>&value=excel', '_blank');
                                            }
                                        },
                                        {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                            className: "btn white btn-outline",
                                            action: function (e, dt, node, config) {
                                                window.open('Fileview?type=it_list&typeop=<%=typeop%>&branch=<%=branch%>&d1=<%=d1%>&d2=<%=d2%>&value=pdf', '_blank');
                                            }
                                        },
