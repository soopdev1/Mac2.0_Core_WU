                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control inputright" name="code_intbook_2" 
                                               id="code_intbook_2" maxlength="5" value="0" onchange="return fieldmaggiorezero(this.id);"  onkeypress="return keysub(this, event);"onfocus="this.select();"> 
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control inputright" name="code_intbook_3" onfocus="this.select();"
                                               id="code_intbook_3" maxlength="5" value="0" onchange="return fieldmaggiorezero(this.id);"  onkeypress="return keysub(this, event);"> 
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
