                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Credit Card - Branch: <%=fil%></span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase"
                                                           id="cod" name="cod" onkeypress="return keysub(this, event);" maxlength="3" value="<%=cc_code%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
