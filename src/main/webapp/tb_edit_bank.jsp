            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_bank" onsubmit="return checkdescr();">
                        ...
                        <input type="hidden" name="oldba_code" value="<%=ba_code%>"/>
                        <input type="hidden" name="datecanc" value="<%=datecanc%>"/>
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" name="ba_code" value="<%=ba_code%>" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" 
                                                           onkeypress="return keysub(this, event);" maxlength="100" value="<%=descr%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
