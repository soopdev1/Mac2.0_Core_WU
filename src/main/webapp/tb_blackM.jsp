...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Blacklist Maccorp</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma3.jsp"%>
            <!-- END MENU -->
            <%                
                ...
                ArrayList<BlacklistM> array_blm = Engine.list_BlMacc();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Blacklist Maccorp</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_blackM.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Blacklist Maccorp</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Blacklist Maccorp</span>
                                    </div>
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow">Surname</th>
                                                                    <th class="tabnow">Name</th>
                                                                    <th class="tabnow">Tax Code</th>
                                                                    <th class="tabnow">Status</th>
                                                                    <th class="tabnow"style="width: 70px;">Actions</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%for (int i = 0; i < array_blm.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=array_blm.get(i).getCode()%></td>
                                                                    <td><%=array_blm.get(i).getCognome()%></td>
                                                                    <td><%=array_blm.get(i).getNome()%></td>
                                                                    <td><%=array_blm.get(i).getCodfisc()%></td>
                                                                    <td><%=Engine.formatStatus_general(array_blm.get(i).getFg_annullato())%></td>
                                                                    <td><%if(central&&tipo.equals("3")){%>

                                                                        <a href="tb_edit_blackM.jsp?view=0&bl_code=<%=array_blm.get(i).getCode()%>" 
                                                                           class="btn btn-sm blue btn-outline btn-circle fancyBoxRafreload">
                                                                            <i class="fa fa-wrench"></i> Edit
                                                                        </a>
                                                                           <%}else{%>
                                                                           <a href="tb_edit_blackM.jsp?view=1&bl_code=<%=array_blm.get(i).getCode()%>" 
                                                                           class="btn btn-sm blue btn-outline btn-circle fancyBoxRaf">
                                            ...
                                            buttons: [
                                               {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=tb_blackM&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=tb_blackM&value=pdf', '_blank');
                                                                        }
                                                                    },
