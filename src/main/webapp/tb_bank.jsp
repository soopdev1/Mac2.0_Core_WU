...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma2.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Bank</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_bank.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Bank</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Bank</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow">Accounting Code</th>
                                                                    <th class="tabnow">Bank Account</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><%=array_bank.get(i)[0]%></td>
                                                                    <td><%=array_bank.get(i)[1]%></td>
                                                                    <td><%=array_bank.get(i)[2]%></td>
                                                                    <td><%=Engine.formatStatus_bankaccount(array_bank.get(i)[5])%></td>
                                                                    <td><%=Engine.formatStatus_general(array_bank.get(i)[4])%></td>
                                                                    <td><%=array_bank.get(i)[3]%></td>
                                                                    <td>
                                                                        <%if(central&&tipo.equals("3")){%>
                                                                        <a href="tb_edit_bank.jsp?ba_code=<%=array_bank.get(i)[0]%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_bank&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_bank&value=pdf', '_blank');
                                                    }
                                                },
