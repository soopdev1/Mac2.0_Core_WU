...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Accounting Code</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma0.jsp"%>
            <!-- END MENU -->
            <%
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Accounting Code</b></small></h3>
                        </div>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Accounting Code</span>
                                    </div>
                                    <div class="actions">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th class="tabnow"style="width: 70px;">Id</th>
                                                            ...
                                                            <tbody>
                                                                <%for (int i = 0; i < contabilita.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=contabilita.get(i)[0]%></td> 
                                                                    <td><%=contabilita.get(i)[1]%></td> 
                                                                    <td><%=contabilita.get(i)[2]%></td> 
                                                                    <td><%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_esolv.jsp?es_code=<%=contabilita.get(i)[0]%>" 
