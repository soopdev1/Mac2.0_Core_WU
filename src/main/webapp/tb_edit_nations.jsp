                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="text" class="form-control uppercase" 
                                                           ...
                                                           value="<%=country_code%>" readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr"name="descr" onkeypress="return keysub(this, event);" value="<%=descr%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="isoc"name="isoc" onkeypress="return keysub(this, event);" value="<%=iso%>"> 
                                                </div>
                                            </div>
                                        </div>
