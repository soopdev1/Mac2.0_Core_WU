...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma9.jsp"%>
            <!-- END MENU -->
            <%                
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Country</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_nations.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Country</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Country</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow" style="width: 70px;">ISO Code</th>
                                                                    <th class="tabnow">Area</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><%=array_country.get(i)[0]%></td>
                                                                    <td><%=array_country.get(i)[1]%></td>
                                                                    <td><%=array_country.get(i)[2]%></td>
                                                                    <td><%=Utility.formatAL(array_country.get(i)[3], array_category_nations, 1) %></td>
                                                                    <td><%if(central&&tipo.equals("3")){%>
                                                                        <a href="tb_edit_nations.jsp?co_code=<%=array_country.get(i)[0]%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=tb_nations&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=tb_nations&value=pdf', '_blank');
                                                                        }
                                                                    },
