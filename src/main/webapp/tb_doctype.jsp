...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Identity Documents</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma15.jsp"%>
            <!-- END MENU -->
            <%                
                String lan_index = (String) session.getAttribute("language");
                lan_index = "IT";
                Etichette et_index = new Etichette(lan_index);
                ArrayList<String[]> array_identcard = Engine.identificationCard();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Identity Documents</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_doctype.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Identity Document</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Identity Documents</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow">OAM Code</th>
                                                                    <th class="tabnow"style="width: 70px;">Actions</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%
                                                                for(int i = 0;i<array_identcard.size();i++){%>
                                                                <tr>
                                                                    <td><%=array_identcard.get(i)[0]%></td>
                                                                    <td><%=array_identcard.get(i)[1]%></td>
                                                                    <td><%=array_identcard.get(i)[2]%></td>
                                                                    <td><%if(central&&tipo.equals("3")){%>
                                                                        <a href="tb_edit_doctype.jsp?doc_code=<%=array_identcard.get(i)[0]%>" 
                                            ...
                                            buttons: [
                                               {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=tb_doctype&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=tb_doctype&value=pdf', '_blank');
                                                                        }
                                                                    },
