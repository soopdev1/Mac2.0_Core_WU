...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Internet Booking</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma16.jsp"%>
            <!-- END MENU -->
            <%                String lan_index = (String) session.getAttribute("language");
                lan_index = "IT";
                Etichette et_index = new Etichette(lan_index);
                ArrayList<String[]> array_internetbooking = Engine.list_internetbooking();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Internet Booking</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_intbook.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Internet Booking</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Internet Booking</span>
                                    </div>
                                    <div class="actions">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                for(int i = 0;i<array_internetbooking.size();i++){%>
                                                                <tr>
                                                                    <td><%=array_internetbooking.get(i)[0]%></td>
                                                                    <td><%=array_internetbooking.get(i)[1]%></td>
                                                                    <td><%if(central&&tipo.equals("3")){%>
                                                                        <a href="tb_edit_intbook.jsp?ib_code=<%=array_internetbooking.get(i)[0]%>" 
                                            ...
                                            buttons: [
                                               {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=tb_intbook&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=tb_intbook&value=pdf', '_blank');
                                                                        }
                                                                    },
