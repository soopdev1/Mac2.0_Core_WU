...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Kind of Transaction</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma18.jsp"%>
            <!-- END MENU -->
            <%                String lan_index = (String) session.getAttribute("language");
                lan_index = "IT";
                Etichette et_index = new Etichette(lan_index);

                ArrayList<CustomerKind> array_customerKind = Engine.list_customerKind();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Kind of Transaction</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_kindtrans.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Kind of Transaction</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Kind of Transaction</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <table class="table table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow">Type Kind</th>
                                                                    <th class="tabnow">Type Customer</th>
                                                                    <th class="tabnow">KYC Threshold </th>
                                                                    <th class="tabnow">Max Weekly</th>
                                                                    <th class="tabnow">Status</th>
                                                                    <th class="tabnow"style="width: 70px;">Actions</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%                                                                    for (int i = 0; i < array_customerKind.size(); i++) {
                                                                        CustomerKind ck = array_customerKind.get(i);
                                                                %>
                                                                <tr>
                                                                    <td><%=ck.getTipologia_clienti()%></td>
                                                                    <td><%=ck.getDe_tipologia_clienti()%></td>
                                                                    <td><%=Utility.formatAL(ck.getFg_nazionalita(), list_type_kind, 1)%></td>
                                                                    <td><%=Utility.formatAL(ck.getFg_tipo_cliente(), list_type_customer, 1)%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(ck.getIp_max_singola_transazione())%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(ck.getIp_max_settimanale())%></td>
                                                                    <td><%=Engine.formatStatus_general(ck.getFg_annullato())%></td>
                                                                    <td>
                                                                        <%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_kindtrans.jsp?view=0&kt_code=<%=ck.getTipologia_clienti()%>" 
                                                                           class="btn btn-sm blue btn-outline btn-circle fancyBoxRafreload"><i class="fa fa-wrench"></i> Edit</a>
                                                                        <%} else {%>
                                                                        <a href="tb_edit_kindtrans.jsp?view=1&kt_code=<%=ck.getTipologia_clienti()%>" 
                                        ...
                                        buttons: [
                                            {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                ...
                                                action: function (e, dt, node, config) {
                                                    ...
                                                    window.open('Fileview?type=tb_kindtrans&value=excel', '_blank');
                                                }
                                            },
                                            {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                ...
                                                action: function (e, dt, node, config) {
                                                    ...
                                                    window.open('Fileview?type=tb_kindtrans&value=pdf', '_blank');
                                                }
                                            },
