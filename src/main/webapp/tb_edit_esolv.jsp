                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="cod" name="cod" onkeypress="return keysub(this, event);" value="<%=es_code%>" readonly="readonly"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" onkeypress="return keysub(this, event);" value="<%=descr%>" onkeyup="return fieldNOSPecial_2(this.id);" maxlength="100"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Accounting Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="acc" name="acc" onkeypress="return keysub(this, event);" value="<%=contcode%>" onkeyup="return fieldOnlyNumber(this.id);" maxlength="10" /> 
                                                </div>
                                            </div>
