        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance Currency <small><b>History Rate</b></small></h3>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <a href="rate_historymo.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
