...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Branch Budget</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma27.jsp"%>
            <!-- END MENU -->
            <%                
                ...
                ArrayList<Branchbudget> list = Engine.list_Branchbudget();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Branch Budget</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_branchbudget.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Branch Budget</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Branch Budget</span>
                                    </div>
                                    <div class="actions">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th class="tabnow">Month/Year</th>
                                                                    <th class="tabnow">Branch ID</th>
                                                                    <th class="tabnow">Budget</th>
                                                                    <th class="tabnow">Budget Online</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><%=Utility.formatStringtoStringDate(list.get(i).getMeseanno(), Constant.patternmonthsql, Constant.pattermonthnorm)%></td>
                                                                    <td><%=list.get(i).getBranch()%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(list.get(i).getBudg1())%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(list.get(i).getBudg2())%></td>
                                                                    <td>
                                                                        <%if(central&&tipo.equals("3")){%>
                                                                            <a href="tb_edit_branchbudget.jsp?gr_code=<%=list.get(i).getCodice()%>" 
