                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="monthyear" name="monthyear" class="form-control date-picker" 
                                                           ...
                                                           data-date-viewmode="years" value="<%=Utility.formatStringtoStringDate(bb.getMeseanno(), Constant.patternmonthsql, Constant.pattermonthnorm)%>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="budg" id="budg" maxlength="15" 
                                                           onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(bb.getBudg1())%>" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="budgon" id="budgon" maxlength="15" 
                                                           onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(bb.getBudg2())%>" 
                                                           onchange="return formatValueDecimal_1(this, '<%=thousand%>', '<%=decimal%>');"> 
                                                </div>
                                            </div>
                                        </div>
