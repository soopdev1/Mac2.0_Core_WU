...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma29.jsp"%>
            <!-- END MENU -->
            <%                String lan_index = (String) session.getAttribute("language");
                lan_index = "IT";
                Etichette et_index = new Etichette(lan_index);
                ArrayList<String[]> array_unlockratejustify = Engine.unlockratejustify();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Unlock Rate Justify</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_unlockrateju.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Unlock Rate Justify</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Unlock Rate Justify</span>
                                    </div>
                                    <div class="actions">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                for(int i = 0;i<array_unlockratejustify.size();i++){%>
                                                                <tr>
                                                                    <td><%=array_unlockratejustify.get(i)[0]%></td>
                                                                    <td><%=array_unlockratejustify.get(i)[1]%></td>
                                                                    <td><%=Engine.formatStatus_general(array_unlockratejustify.get(i)[2])%></td>
                                                                    <td><%if(central&&tipo.equals("3")){%>
                                                                        <a href="tb_edit_unlockrateju.jsp?un_code=<%=array_unlockratejustify.get(i)[0]%>" 
